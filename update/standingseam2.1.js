                                    ...
                                    <div className="orderOptionsSpecsForm">
                                        <div className="orderOptionsSpecsFormTitle">
                                            ...
                                            <FormGroup className="orderOptionsSpecsFG">
                                                ...
                                                <Input type="text" className="orderOptionsSpecsInput" placeholder={this.props.obj.totallinearfeet} name="totallinearfeet" readOnly />
                                            ...
                                            <FormGroup className="orderOptionsSpecsFG">
                                                ...
                                                <Input type="text" className="orderOptionsSpecsInput" placeholder={this.props.obj.totalsquarefeet} name="totalsquarefeet"  readOnly />
