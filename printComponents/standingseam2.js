                                ...
                                <Form className="orderOptionsContentForm" onSubmit={this.handleSumbit}>
                                    ...
                                    <div className="orderOptionsFlashingsMainContainer">
                                        <div className="orderOptionsFlashingsContainerSmall">
                                            {this.props.obj.hookdrip1?<FormGroup className="orderOptionsFlashingsContainer3"> 
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.hookdrip1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.hookdripsteppitch?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.hookdripsteppitch}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.gabbleRake1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.gabbleRake1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.gabbleRake2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.gabbleRake2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.gabbleRake3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.gabbleRake3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.sidewall1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.sidewall1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.sidewall2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.sidewall2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.endwall1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.endwall1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.endWall2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.endWall2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.endwall3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.endwall3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.transition1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.transition1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.transition2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.transition2}</p>
                                            </FormGroup>:""}
                                            {this.props.obj.transition3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.transition3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.peakcap1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.peakcap1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.peakcap2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.peakcap2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.peakcap3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.peakcap3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.hip1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.hip1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.hip2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.hip2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.hip3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.hip3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.ridge1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.ridge1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.ridge2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.ridge2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.ridge3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.ridge3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.ridge4?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.ridge4}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.wvalley1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.wvalley1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.wvalley2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.wvalley2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.vvalley1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.vvalley1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.snowstop1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.snowstop1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.cleat?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.cleat}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.junderbarrel?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.junderbarrel}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.zbaroverbarrel?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.zbaroverbarrel}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.perforatedjunderbarrel?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.perforatedjunderbarrel}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.perforatedzbaroverbarrel?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.perforatedzbaroverbarrel}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.backpan5?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.backpan5}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.backpan10?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.backpan10}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.base1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.base1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.base2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.base2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.base3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.base3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.windowheader?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.windowheader}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.windowreverse?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.windowreverse}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.walltransition?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.walltransition}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.jtrim1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.jtrim1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.jtrim2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.jtrim2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.jtrim3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.jtrim3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.transition?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.transition}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.outsidecorner1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.outsidecorner1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.insidecorner1?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.insidecorner1}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.outsidecorner2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.outsidecorner2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.insidecorner2?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.insidecorner2}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.outsidecorner3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.outsidecorner3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.insidecorner3?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.insidecorner3}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.outsidecorner4?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.outsidecorner4}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.insidecorner4?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.insidecorner4}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.standing290?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.standing290}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.standing291?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.standing291}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.standing292?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.standing292}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.standing293?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.standing293}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.standing294?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.standing294}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.standing295?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput3">QTY: {this.state.standing295}</p>
                                            </FormGroup>:''}
                                        </div>
                                    </div>
                                    <br/><br/><br/><br/><br/><br/>
                                    ...
                                    <div className="orderOptionsFlashingsContainerSmall">
                                        {this.props.obj.metalDrillScrews?<FormGroup className="orderOptionsFlashingsContainer3"> 
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.metalDrillScrews}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.woodGripScrews?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.woodGripScrews}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.syntheticHighTempCover?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.syntheticHighTempCover}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.tubeSealant?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.tubeSealant}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.butylTape?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.butylTape}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.plumbingBoots?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.plumbingBoots}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.flexOVent?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.flexOVent}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.profileOuterClosure?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.profileOuterClosure}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.profileInnerClosure?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.profileInnerClosure}</p>
                                            </FormGroup>:''}
                                            {this.props.obj.lowProfileRidgeVent?<FormGroup className="orderOptionsFlashingsContainer3">
                                                ...
                                                <p className="orderOptionsFlashingsInput4">QTY: {this.state.lowProfileRidgeVent}</p>
                                            </FormGroup>:''}
                                        </div>
