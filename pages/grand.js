        ...
        return (
            <div className="diamondMainContainer">
                ...
                <div className="productPage3rdContainer">
                    <img className="productPageImage" src="https://firebasestorage.googleapis.com/v0/b/jays-metal-products.appspot.com/o/products%2Fgrand-1236.png?alt=media&token=be783f65-597b-4be8-af55-a636092a8d39"></img>
                    <img className="productPageImage" src="https://firebasestorage.googleapis.com/v0/b/jays-metal-products.appspot.com/o/productsPages%2Fgrandspecs.png?alt=media&token=db363fe9-0cd0-451a-a29f-1f6ff1e014db"></img>
                </div>
                            ...
                            <div className="orderOptionsContent">
                                <Form className="orderOptionsContentForm" onSubmit={this.handleSumbit}>
                                    <div className="orderOptionsTextForm">
                                        <h2 className="orderOptionsTextFormTitle">Grand 1236</h2>
