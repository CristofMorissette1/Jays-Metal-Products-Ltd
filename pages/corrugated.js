...
class Corrugated extends Component{
    constructor(){
        super()
        this.state = {
            colorOptions: false,
        ...
        return (
            <div className="diamondMainContainer">
                ...
                <div className="productPage3rdContainer">
                    <img className="productPageImage" src="https://firebasestorage.googleapis.com/v0/b/jays-metal-products.appspot.com/o/products%2Fcorrugated-.png?alt=media&token=45e9ac3c-48ad-414b-88ef-522e088fb96d"></img>
                    <img className="productPageImage" src="https://firebasestorage.googleapis.com/v0/b/jays-metal-products.appspot.com/o/productsPages%2Fcorrugatedspecs.png?alt=media&token=be0e8a32-12a7-4611-99dc-220fac322e8c"></img>
                </div>
                            ...
                            <div className="orderOptionsContent">
                                <Form className="orderOptionsContentForm" onSubmit={this.handleSumbit}>
                                    <div className="orderOptionsTextForm">
                                        <h2 className="orderOptionsTextFormTitle">Corrugated 7/8</h2>
