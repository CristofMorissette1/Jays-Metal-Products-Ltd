...
import Standingseam2Print from '../printComponents/iconpanels';
    ...
    handleChange = e => {
      ...
      handleSumbit(e) {
        ...
        const { customerName, productname, phone, po, email, address, ga, color, protectivefilm, finish, totallinearfeet, totalsquarefeet, qty, inch, mm, tag, specialcrating, linearfeet, squarefeet, qty2, inch2, mm2, tag2, linearfeet2, squarefeet2, qty3, inch3, mm3, tag3, linearfeet3, squarefeet3, qty4, inch4, mm4, tag4, linearfeet4, squarefeet4, qty5, inch5, mm5, tag5, linearfeet5, squarefeet5, qty6, inch6, mm6, tag6, linearfeet6, squarefeet6, qty7, inch7, mm7, tag7, linearfeet7, squarefeet7, qty8, inch8, mm8, tag8, linearfeet8, squarefeet8, qty9, inch9, mm9, tag9, linearfeet9, squarefeet9, qty10, inch10, mm10, tag10, linearfeet10, 
            ...
            squarefeet10, i101, i102, i103, i104, i106, i107, i108, i111, i113, i112, i116, i117, i118, i119, i114, i115, i120, i121, i122, i123, i128, i129, i130, i131, vvalley1, snowstop1, cleat, junderbarrel, zbaroverbarrel, perforatedjoverbarrel, perforatedzbaroverbarrel, backpan5, backpan10, base1, base2, base3, windowheader, windowreverse, walltransition, jtrim1, jtrim2, jtrim3, transition, outsidecorner1, insidecorner1, outsidecorner2, insidecorner2, outsidecorner3, insidecorner3, outsidecorner4, insidecorner4, standing290, standing291, standing292, standing293, standing294, standing295} = this.state;
                                    ...
                                    <div className="orderOptionsSpecsForm">
                                        <div className="orderOptionsSpecsFormTitle">
                                            ...
                                            <FormGroup className="orderOptionsSpecsFG">
                                                ...
                                                <Input type="text" className="orderOptionsSpecsInput" value={this.state.totalsquarefeet} name="totalsquarefeet" placeholder={this.state.totalsquarefeet} readOnly />
                                            </FormGroup>
                                        </div>
                                    ...
                                    <div className="orderOptionsFlashingsMainContainer">
                                        ...
                                        <div className="orderOptionsFlashingsContainerSmall">
                                            <FormGroup className="orderOptionsFlashingsContainer2"> 
                                                ...
                                                {this.state.i101?<CustomInput
                                                    className="orderOptionsFlashingsInput2" 
                                                    name="i101"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value = {this.state.i101}
                                                    onChange={this.handleChange}
                                                    />:<CustomInput
                                                    className="orderOptionsFlashingsInput2" 
                                                    name="i101"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i102?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i102}
                                                    name="i102"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i103?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i103}
                                                    name="i103"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i104?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i104}
                                                    name="i104"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i106?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i106}
                                                    name="i106"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i107?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i107}
                                                    name="i107"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i108?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i108}
                                                    name="i108"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i111?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i111}
                                                    name="i111"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i112?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i112}
                                                    name="i112"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i113?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i113}
                                                    name="i113"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i114?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i114}
                                                    name="i114"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i115?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i115}
                                                    name="i115"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i116?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i116}
                                                    name="i116"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i117?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i117}
                                                    name="i117"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i118?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i118}
                                                    name="i118"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i119?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i119}
                                                    name="i119"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i120?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i120}
                                                    name="i120"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i121?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i121}
                                                    name="i121"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i122?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i122}
                                                    name="i122"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i123?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i123}
                                                    name="i123"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i128?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i128}
                                                    name="i128"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i129?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i129}
                                                    name="i129"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i130?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i130}
                                                    name="i130"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer2">
                                                ...
                                                {this.state.i131?<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                                    // placeholder="QTY"
                                                    value={this.state.i131}
                                                    name="i131"
                                                    onChange={this.handleChange} />:<CustomInput 
                                                    className="orderOptionsFlashingsInput2"
                                                    type="text"
                                    ...
                                    <h2 className="orderOptionsTitle">ACCESSORIES:</h2>
                                        <div className="orderOptionsFlashingsContainerSmall">
                                            ...
                                            <FormGroup className="orderOptionsFlashingsContainer">
                                                ...
                                                {a= "peel&StickHighTempCover"}
                                                {this.state.a?<CustomInput 
                                                    className="orderOptionsAccessoriesInput"
                                                    type="text"
                                                    id="annoying"
                                                    // placeholder="QTY"
